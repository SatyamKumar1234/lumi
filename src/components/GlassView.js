...
const GlassView = ({ children, style, intensity = 20, onPress, ...props }) => {
    ...
    return (<Animated.View style={[{ transform: [{ scale: scaleAnim }] }, style]}>
            <Container onPress={onPress} onPressIn={onPress ? handlePressIn : undefined} onPressOut={onPress ? handlePressOut : undefined} style={[
            styles.glass,
