...
import { FileText, Upload, Trash2, Sparkles, Image as ImageIcon, Plus, X } from 'lucide-react';
    ...
    return (<ScrollView style={styles.container} contentContainerStyle={styles.content}>
            <View style={styles.headerRow}>
                ...
                <View style={{ flexDirection: 'row', gap: 10 }}>
                    <TouchableOpacity style={[styles.uploadButton, { backgroundColor: theme.colors.primary }]} onPress={() => setShowAddNote(true)}>
            ...
            <Modal visible={showAddNote} transparent animationType="fade">
                <View style={styles.modalOverlay}>
                    <GlassView style={[styles.modalContent, { backgroundColor: theme.colors.card }]} intensity={90}>
                        ...
                        <TextInput style={[styles.input, { color: theme.colors.text, borderColor: theme.colors.border }]} placeholder="Note Title" placeholderTextColor={theme.colors.textSecondary} value={noteTitle} onChangeText={setNoteTitle}/>
                        <TextInput style={[styles.textArea, { color: theme.colors.text, borderColor: theme.colors.border }]} placeholder="Type your notes here..." placeholderTextColor={theme.colors.textSecondary} multiline value={noteContent} onChangeText={setNoteContent} textAlignVertical="top"/>
            ...
            <View style={styles.grid}>
                {files.map((file) => (<GlassView key={file.id} style={[styles.fileCard, { backgroundColor: theme.colors.card }]} intensity={20}>
            ...
            ]} onPress={() => handleGenerateFlashcards(file)} disabled={file.type !== 'text' && file.type !== 'manual'}>
