...
import { Play, Pause, RotateCcw, Music, Image as ImageIcon, Type, Volume2, VolumeX, X, Check } from 'lucide-react';
...
const TimerScreen = () => {
    ...
    const modes: { [key: string]: { label: string; minutes: number } } = {
    ...
    const handleSetColor = (color: string | null) => {
        ...
        if (color) localStorage.setItem('lumina_timer_color', color);
        else localStorage.removeItem('lumina_timer_color');
                ...
                <View style={styles.modalOverlay}>
                    <GlassView style={[styles.modalContent, { backgroundColor: theme.colors.card }]} intensity={80}>
                        ...
                        <View style={styles.colorGrid}>
                            {['#FFFFFF', '#000000', '#FF3B30', '#34C759', '#007AFF', '#FFCC00', '#AF52DE', '#FF2D55'].map(c => (
                                <TouchableOpacity key={c} style={[styles.colorOption, { backgroundColor: c }]} onPress={() => handleSetColor(c)}>
