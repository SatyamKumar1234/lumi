...
const App = () => {
    ...
    const handleSetBackgroundImage = (uri) => {
        setBackgroundImage(uri);
        if (uri)
            localStorage.setItem('lumina_background', uri);
        else
            localStorage.removeItem('lumina_background');
    };
    ...
    return (<UserContext.Provider value={{ userName, setUserName: handleSetUserName, backgroundImage, setBackgroundImage: handleSetBackgroundImage }}>
